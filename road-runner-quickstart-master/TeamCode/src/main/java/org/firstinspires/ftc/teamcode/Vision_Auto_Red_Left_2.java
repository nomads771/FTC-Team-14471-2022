...
public class Vision_Auto_Red_Left_2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //slide decision 
       if(zone == 1) {
            robot.leftArmMotorDeg(0.5, -120, 5);
            delay(0.5);
            robot.moveDistance(14, 0.7);
        }
        else if(zone == 2) {
            robot.leftArmMotorDeg(0.5, -350, 5);
            delay(0.5);
            robot.moveDistance(14, 0.7);
        }
        else {
            robot.leftArmMotorDeg(0.5, -620, 5);
            delay(0.5);
            robot.moveDistance(14, 0.7);
        }
        delay(0.5);
        ...
        //reset arm
        if(zone == 1) {
            robot.leftArmMotorDeg(0.5, 100, 5);
            delay(0.5);
        }
        else if(zone == 2) {
            ...
            robot.leftArmMotorDeg(0.5, 600, 5);
            delay(0.5);
        }
        robot.turnAngle(-123, 0.5);
        delay(0.3);
        robot.moveDistance(30, 1.0);
        delay(0.3);
        robot.strafeInches(0.5, 9, 5);
        delay(0.3);
        robot.turnAngle(-5, 0.5);
        delay(0.3);
